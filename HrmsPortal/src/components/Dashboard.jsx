...
const Dashboard = () => {
    ...
    <>
        <div className='header shadow-2xl bg-gradient-to-br from-yellow1 to-blue1 flex justify-evenly'>
            ...
            <div className='flex'><CgProfile className='nav-profile flex justify-center mt-4 mb-2 text-5xl text-white '/><p className='text-white mt-7 ml-1 text-l font-semibold'><Link to="/profile">Profile</Link></p></div>
        </div>
